...
<html>
    ...
    <center>
        <div class="container d-flex align-items-center">
            ...
            <p style="font-family: Arial Black; font-size:xx-large">"KING AND QUEEN BERBER" KULLANICI GIRISI</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <form action="<?php $_PHP_SELF ?>" method="POST">
                        <?php 
                            if(isset($mesaj)){//hata mesaji varsa
                                echo "<br>".$mesaj."<br>";
                            }
                        ?>
                        ...
                        <div class="form-group" style="font-family: cooper black;">
                            ...
                            <a href="kayitSayfasi.php"><b>Kayit Ol</b></a>
                        </div>
                    </form>
                </div>
                <div class="col-sm-2"></div>
