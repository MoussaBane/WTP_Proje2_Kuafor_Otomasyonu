...
<html>
    <head>
        <title>Kuafor Otomasyonu Randevu Gunceleme Sayfasi</title>
        <meta charset="UTF-8">
    ...
    <body style="background-color:antiquewhite;">
        ...
        <center>
            <div class="container d-flex align-items-center">
                ...
                <p style="font-family: Arial Black; font-size:xx-large">"KING AND QUEEN BERBER" KULLANICI RANDEVU GUNCELEME FORMU</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <form action="randevuGuncelKaydet.php?id=<? echo $_GET['id'] ?>" method="POST">
