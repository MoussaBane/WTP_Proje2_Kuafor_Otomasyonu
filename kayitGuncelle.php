<?php
    ...
    $sql = "SELECT * FROM kullanicitable WHERE ID=".$_GET['id'];
    
    //sorguyu veritabanina gönderiyoruz.
    $cevap = mysqli_query($MySql_Baglanti,$sql);
    //eger cevap FALSE ise hata yazdiriyoruz. 
    if(!$cevap ){
        echo '<br>Hata Mesaji:' . mysqli_error($MySql_Baglanti);
    }
...
<html>
    <head>
        <title>Kuafor Otomasyonu Kayit Gunceleme Sayfasi</title>
        <meta charset="UTF-8">
    ...
    <body style="background-color:antiquewhite;">
        ...
        <center>
            <div class="container d-flex align-items-center">
                ...
                <p style="font-family: Arial Black; font-size:xx-large">"KING AND QUEEN BERBER" KAYIT GUNCELEME FORMU</p>
                
                <div class="row">
                    
                    <div class="col-sm-2"></div>
                    <div class="col-sm-8">
                        <form action="kayitGuncelKaydet.php?id=<? echo $_GET['id'] ?>" method="POST">
